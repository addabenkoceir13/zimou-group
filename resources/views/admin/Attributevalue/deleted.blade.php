<div class="modal fade" id="deleteAttributeVAlueModal{{ $attribute->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{ route('dashboard.attributevalue.destroy', $attribute->id) }}" method="POST">
            @csrf
            @method('DELETE')
