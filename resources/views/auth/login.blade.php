                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="login-form">
                                    <h5 class="text-capitalize" style="font-weight: bold">{{ __('Log In') }}</h5>
                                    ...
                                    {{ __('Don\'t have an account?') }}<a href="{{ route('auth.user.showRegisterForm') }}"
                                        class="text-decoration-none  ml-2">{{ __('Create a new account') }}</a>
